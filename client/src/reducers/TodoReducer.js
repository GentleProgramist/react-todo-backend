import {FETCH_ACTIONS_SUCCESS, FETCH_ACTIONS_FAILURE,ADD_ACTION,EDIT_ACTION,DELETE_ACTION} from '../actions/constants'
...
export default function(state = initialState, action) {
    switch(action.type){
        ...
        case EDIT_ACTION:
            console.log('Edit action',{...state,actions: [...state.actions,action.payload]})
            return {...state,actions: [...state.actions,action.payload]}
        case DELETE_ACTION:
